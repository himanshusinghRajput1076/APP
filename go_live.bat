@echo off
title IDEACON Live Server Starter (Cloudflare Tunneled)
echo =======================================================
echo    IDEACON APPS - SECURE LIVE SERVER DEPLOYMENT
echo =======================================================
echo.

IF NOT EXIST "cloudflared.exe" (
    echo [Security] Downloading Cloudflare Tunnel (cloudflared.exe)...
...
echo Step 2: Creating a secure Cloudflare tunnel for the backend...
...
echo Scroll up slightly and find the URL that looks like:
...
echo Saved secure Cloudflare backend URL to frontend configuration!
echo.
...
echo Step 5: Creating a secure Cloudflare tunnel for the frontend...
start "Frontend Tunnel" cmd /k "cd /d e:\IDEACON && cloudflared.exe tunnel --url http://localhost:3000"
echo.
echo =======================================================
echo ALL DONE! Look at the "Frontend Tunnel" window.
echo The URL printed there is your FINAL SECURE LIVE APP URL!
